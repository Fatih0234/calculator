...
<p align="left">
Hey there, In this project I have built a calculator with tkinter GUI. I have built this application by benefitting Object Oriented Programming of Python.
OOP made it possible to be easy to work with and make flexible changes.  
</p>


<h1>How to run the app? </h1>

<p>Either fork or download the app and open the program in the command line interface. </p>

<h1>How to use the app?</h1>
<p> You could either use your mouse or keyboard in order to give input to the program and then afterwads do your calculation. </p>

<h1>Features of the program</h1>
1. You can square root or square the input you have given.
2. There are two displays. One follows your each input and appears on the top. The other one follows your last input and appears on the bottom. 
...
<img src="calc.png" alt="calculator" width="300" height="500">
